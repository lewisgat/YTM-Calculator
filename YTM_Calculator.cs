...
namespace YTM_Calculator
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The YTM was  calculated to be " + Math.Round(rA[0] * 100, 4) + "%.\nThis took the Newton-Raphson algorithm " + rA[1] + " iterations to compute.");
            Console.WriteLine("\n");
            ...
            Console.WriteLine("The YTM was calculated to be " + Math.Round(rB[0] * 100, 4) + "%.\nThis took the Newton-Raphson algorithm " + rB[1] + " iterations to compute.");
            Console.WriteLine("\n");
            ...
            Console.WriteLine("The YTM was calculated to be " + Math.Round(rC[0] * 100, 4) + "%.\nThis took the Newton-Raphson algorithm " + rC[1] + " iterations to compute.");
            Console.WriteLine("\n");
            ...
            Console.WriteLine("The Bond Price is " + Math.Round(bp, 4) + "% of par");
            Console.WriteLine("\n");
